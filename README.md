...
- Using JavaCV had two problems for me. Firstly, it results in an .apk file size of ~50MB and secondly I couldn't get any of the audio CODECS to work. Trying to set an audio CODEC for the ffmpegFrameGrabber always results in an audioCodecNotFound exception. This is really a pity, because making the video without sound is fairly painless and works quite well.
